 ...
 */
package com.terrencealuda.tcardio.presentation.tempexerciseviews
...
import com.terrencealuda.tcardio.services.ExerciseStateChange
...
fun ExerciseScreen(
    ...
    when (serviceState) {
        is ServiceState.Connected -> {
            ...
            val laps by  remember { mutableStateOf(getExerciseServiceState.exerciseLaps) }
            ...
            val elapsedTime =  remember { derivedStateOf {
                formatElapsedTime(
